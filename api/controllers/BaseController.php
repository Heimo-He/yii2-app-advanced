...
class BaseController extends ActiveController
{
    ...
    public function afterAction($action, $result)
    {
        ...
        if(Yii::$app->params['Authorization'] && $identity && Yii::$app->cache->get('access-token_' . $identity->access_token) - time() <= 600){
            $identity->generateAccessToken();
            Yii::$app->response->headers['Authorization-Access-Token'] = $identity->access_token;
        }
